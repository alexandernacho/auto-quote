...
Added proper query optimization with relevant indexes
...
clientsTable (from "@/db/schema"): Drizzle schema for "clients" table
...
import { clientsTable, InsertClient, SelectClient } from "@/db/schema"
